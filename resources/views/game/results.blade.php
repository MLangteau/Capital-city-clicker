...
@section('content')
    ...
    <div class="container result">
        ...
        if ($percentCorrect > 80){
            echo("<h3>"."Percentage correct for questions answered:  ".$percentCorrect."%     FANTASTIC :) !</h3>");
        }
        else
            ...
            {
            echo("<h3>"."Percentage correct for questions answered: ".$percentCorrect."% Better Luck Next Time.</h3>");
        }
